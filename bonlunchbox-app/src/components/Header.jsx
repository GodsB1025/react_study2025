    ...
    return (
        <div className="header-box">
            <div className="header-box-logo">
                ...
                <Link to={"/"}>
                    <img src="https://cdn.bonif.co.kr/resources/web/css/images/logo_gnb.png" alt="이미지" />
                </Link>
            </div>
            ...
            <div className="header-box-util">
                {authenticate ? <button onClick={doLogout}>로그아웃</button> : <button onClick={goToLogin}>로그인</button>}
            </div>
        </div>
    );
};
